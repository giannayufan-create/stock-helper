...
export const quickJumpWrap = style({
    display: 'flex',
    alignItems: 'center',
    gap: vars.space.xs,
    padding: '2px 6px',
...
export const quickJumpInput = style({
    flex: 1,
    minWidth: 0,
    border: 'none',
    outline: 'none',
...
export const quickJumpBtn = style({
    fontFamily: vars.font.display,
    fontSize: '0.66rem',
    border: `1px solid ${vars.color.border}`,
    borderRadius: vars.radius.sm,
...
export const ageLive = style({
    color: vars.color.mutedForeground,
    fontSize: '0.64rem',
});

export const ageWarn = style({
    color: vars.color.amber,
    fontSize: '0.64rem',
    fontWeight: 600,
});

export const ageDanger = style({
